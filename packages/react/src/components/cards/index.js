...
import _SectionMarkerCard from './SectionMarkerCard';
...
const _HeaderCard = { ..._SectionMarkerCard, name: 'HeaderCard' };
const _ChapterCard = { ..._SectionMarkerCard, name: 'ChapterCard' };
...
export const SectionMarkerCard = _SectionMarkerCard;
...
export const cards = {
  ...
  SectionMarkerCard: _SectionMarkerCard,
